...
variable "resources" {
  description = "Resources to use with the application. Details about available options can be found at https://charmhub.io/sdcore-gnbsim-k8s-operator/configure."
  type        = map(string)
  default     = {}
}
