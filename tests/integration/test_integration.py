...
async def _deploy_nms_mock(ops_test: OpsTest):
    ...
    any_charm_src_overwrite = {
        ...
        "any_charm.py": textwrap.dedent(
            """\
        from fiveg_core_gnb import FivegCoreGnbRequires, PLMNConfig
        ...
        class AnyCharm(AnyCharmBase):
            ...
            def fiveg_core_gnb_relation_changed(self):
    ...
    await ops_test.model.add_relation(NMS_MOCK, f"{NRF_CHARM_NAME}:sdcore_config")
    await ops_test.model.add_relation(NMS_MOCK, f"{AMF_CHARM_NAME}:sdcore_config")
